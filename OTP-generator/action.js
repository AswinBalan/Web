function myFunction()
{
 ...
 window.alert("OTP sent to "+mobile_number);
  ...
  var url ="http://localhost:7000/node_server.js?mobile=" + mobile_number +"&check=1";
...
function verifyotp()
{
  ...
  var url ="http://localhost:7000/node_server.js?mobile="+mobile_number+"&otp=" + verify_otp+"&check=2";
  //window.alert(url);
  xhttp.open("GET",url, true);
  xhttp.send();
}
